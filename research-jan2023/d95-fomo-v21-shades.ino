...
// Bracket the next line out if you don't want to use the 128x128 grayscale OLED
...
const int MY_SERVO_SLIGHT_LOW = 79;
const int MY_SERVO_STRAIGHT = 91;
