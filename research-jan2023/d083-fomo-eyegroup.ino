...
*/
        ...
        if (String(bb.label).substring(0, 1) == "1"){  // 1bigeyeFast
         ...
         // int myVertical = 96-(int)bb.y;   // from 0-96 --> 96 to 0 
         // int myTurning2 = round( atan2 (myVertical, abs(myTurning)) * 180/3.14159265 ); // radians to degrees and rounding        
       ...
       */
          ...
          // No change needed if they are already the same.
         // if (myServoNow == myServoAngle) {myServoNow = myServoAngle;}
