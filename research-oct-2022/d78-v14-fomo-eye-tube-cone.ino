...
/* Includes ---------------------------------------------------------------- */
#include <ei-fomo-v14-2022-eye-tube-cone_inferencing.h>
...
const int MY_SERVO_SLIGHT_LOW = 75;
const int MY_SERVO_STRAIGHT = 90;
const int MY_SERVO_SLIGHT_HIGH = 105;
     ...
     */
       ...
       // display.drawRect(bb.x/2, bb.y/2, bb.width*3, bb.height*3, SSD1327_WHITE ); 
        ...
        if (myValue  > 75 && String(bb.label).substring(0, 1) == "2"){ //  2 tube
          ...
          myServoNow = MY_SERVO_SLIGHT_LOW ;   //MY_SERVO_SLIGHT_LOW;         
        }
